...
TEST_PARAM test_parameter = {
    "guix_all_widgets_synergy_16bpp_flip", /* Test name */
...
#define _gx_synergy_display_driver_setup gx_validation_dave2d_graphics_driver_setup_565rgb
...
#include "demo_guix_all_widgets_synergy_16bpp_flip.c"

GX_WINDOW *screen_list[]={
(GX_WINDOW *)&gauge_screen,
(GX_WINDOW *)&glyph_screen,
