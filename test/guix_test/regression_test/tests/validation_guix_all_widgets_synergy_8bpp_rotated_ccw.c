...
TEST_PARAM test_parameter = {
    "guix_all_widgets_synergy_8bpp_rotated_ccw", /* Test name */
...
#include "demo_guix_all_widgets_synergy_8bpp_rotated_ccw.c"

extern GX_STUDIO_DISPLAY_INFO all_widgets_synergy_8bpp_rotated_ccw_display_table[];
...
GX_CONST GX_THEME *theme_ptr;
    ...
    /* Save palette info. */
    theme_ptr = all_widgets_synergy_8bpp_rotated_ccw_display_table[MAIN_DISPLAY].theme_table[MAIN_DISPLAY_THEME_1];
