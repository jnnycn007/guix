...
TEST_PARAM test_parameter = {
    "guix_all_widgets_synergy_24xrgb_rotated_cw_pixelmap_draw", /* Test name */
...
#define _gx_synergy_display_driver_setup gx_validation_dave2d_graphics_driver_setup_24xrgb_rotated
...
#include "demo_guix_all_widgets_synergy_24xrgb_rotated_cw.c"

char test_comment[256];

GX_RESOURCE_ID test_map_id_list[]=
{
GX_PIXELMAP_ID__24XRGB_C_A,
GX_PIXELMAP_ID__24XRGB_C,
GX_PIXELMAP_ID__24XRGB_A,
GX_PIXELMAP_ID__24XRGB,
GX_PIXELMAP_ID__32ARGB_A,
GX_PIXELMAP_ID__32ARGB_C_A,
GX_PIXELMAP_ID__565RGB_C,/* Compress. */
GX_PIXELMAP_ID__565RGB, /* Raw. */
GX_PIXELMAP_ID__4444ARGB_C_A, /* 4444argb compressed alpha. */
GX_PIXELMAP_ID__4444ARGB_A, /* 4444argb alpha. */
GX_PIXELMAP_ID__PALETTE_C, /* 8bit palette compressed. */
GX_PIXELMAP_ID__PALETTE, /* 8bit palette raw. */
GX_PIXELMAP_ID__ALPHAMAP_C_A, /* alphamap compressed. */
GX_PIXELMAP_ID__ALPHAMAP_A, /* alphamap raw. */
GX_PIXELMAP_ID__JPEG,
GX_PIXELMAP_ID__PNG,
GX_PIXELMAP_ID__PNG_A
};
