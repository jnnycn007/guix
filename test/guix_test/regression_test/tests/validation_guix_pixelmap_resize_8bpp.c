...
TEST_PARAM test_parameter = {
    "guix_pixelmap_resize_8bpp", /* Test name */
...
#include "demo_guix_pixelmap_resize_8bpp.c"
...
extern GX_STUDIO_DISPLAY_INFO pixelmap_resize_8bpp_display_table[];
...
GX_CONST GX_THEME *theme_ptr;
    ...
    /* Save palette info. */
    theme_ptr = pixelmap_resize_8bpp_display_table[DISPLAY_1].theme_table[DISPLAY_1_THEME_1];
