...
TEST_PARAM test_parameter = {
    "guix_numeric_prompt", /* Test name */
    447, 31, 568, 56   /* Define the coordinates of the capture area.
...
int      value;
    ...
    for( value = -10000 ; value < 10000 ; value += 1234)
    {
        ...
        gx_numeric_prompt_value_set(&text_screen.text_screen_numeric_prompt, value);
