...
TEST_PARAM test_parameter = {
    "guix_utility_canvas_to_bmp_1555xrgb_no_output", /* Test name */
...
#include "demo_guix_screenshot_to_bitmap_1555xrgb.c"
...
int  pathlen;
char relative_path[]="../../../example_internal/screenshot_to_bitmap/screenshot_to_bitmap_1555xrgb/";
