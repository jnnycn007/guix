...
TEST_PARAM test_parameter = {
    "guix_vertical_list_scroll_with_large_value", /* Test name */
...
VOID send_drag_event_to_scroll_list(GX_VERTICAL_LIST *list, int distance)
{
GX_EVENT my_event;
    ...
    my_event.gx_event_payload.gx_event_pointdata.gx_point_y += distance;
...
VOID send_scroll_event_to_wrap_list(GX_VERTICAL_LIST *list, int distance)
{
GX_EVENT my_event;
...
GX_VERTICAL_LIST *wrap_list = &window.window_vertical_list_wrap;
INT               index = 0;
...
GX_ENTER_CRITICAL
            ...
            sprintf(test_comment, "Drag scroll list down by 30000");
...
GX_ENTER_CRITICAL
            send_drag_event_to_scroll_list(list, -30000);
            sprintf(test_comment, "Drag scroll list up by 30000");
...
GX_EXIT_CRITICAL
        ...
        case 2:
            ...
            sprintf(test_comment, "scroll wrap list down by 70000");
            break;

        case 3:
            /* Scroll wrap list up by 70000.  */
            send_scroll_event_to_wrap_list(wrap_list, -70000);
            sprintf(test_comment, "scroll wrap list up by 70000");
            break;
