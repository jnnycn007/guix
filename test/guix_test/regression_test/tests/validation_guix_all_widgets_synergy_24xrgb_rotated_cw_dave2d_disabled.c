...
TEST_PARAM test_parameter = {
    "guix_all_widgets_synergy_24xrgb_rotated_cw_dave2d_disabled", /* Test name */
...
#define _gx_synergy_display_driver_setup gx_validation_graphics_driver_setup_24xrgb_rotated
...
#include "demo_guix_all_widgets_synergy_24xrgb_rotated_cw_dave2d_disabled.c"
