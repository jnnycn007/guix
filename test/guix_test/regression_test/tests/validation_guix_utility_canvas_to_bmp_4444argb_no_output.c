...
TEST_PARAM test_parameter = {
    "guix_utility_canvas_to_bmp_4444argb_no_output", /* Test name */
...
#include "demo_guix_screenshot_to_bitmap_4444argb.c"
...
int  pathlen;
char relative_path[]="../../../example_internal/screenshot_to_bitmap/screenshot_to_bitmap_4444argb/";
