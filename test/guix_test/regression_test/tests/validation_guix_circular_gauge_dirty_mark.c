...
TEST_PARAM test_parameter = {
    "guix_circular_gauge_dirty_mark", /* Test name */
...
GX_EVENT myevent;
    ...
    gx_validation_set_frame_comment("angle = 0");
    gx_validation_screen_refresh();

    gx_widget_shift(gauge, 0, -30, GX_TRUE);
    gx_circular_gauge_angle_set(gauge, 60);
    gx_validation_set_frame_id(frame_id++);
    gx_validation_set_frame_comment("shift gauge widget up by 30 pixels, set gauge angle to 60");
