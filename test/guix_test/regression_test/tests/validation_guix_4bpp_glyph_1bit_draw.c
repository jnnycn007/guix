...
TEST_PARAM test_parameter = {
    "guix_4bpp_glyph_1bit_draw", /* Test name */
    55, 24, 362, 48  /* Define the coordinates of the capture area.
...
GX_PROMPT *prompt;
    ...
    gx_utility_rectangle_define(&size, 55, 24, 362, 48);
    ...
    /* Set text font. */
    gx_prompt_font_set(prompt, GX_FONT_ID_NORMAL_FONT);

    gx_validation_set_frame_id(frame_id++);
    gx_validation_set_frame_comment("test 4bpp glyph 1bit draw");
