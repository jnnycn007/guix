...
TEST_PARAM test_parameter = {
    "guix_standalone_binres_load_8bpp", /* Test name */
...
#include "demo_guix_standalone_binres_load_8bpp.c"
...
GX_DISPLAY *display = root->gx_window_root_canvas->gx_canvas_display;
    ...
    /*Save palette. */
    gx_validation_write_palette(display->gx_display_palette, display->gx_display_palette_size);
