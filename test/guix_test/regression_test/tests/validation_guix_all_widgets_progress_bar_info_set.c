...
TEST_PARAM test_parameter = {
    "guix_all_widgets_progress_bar_info_set", /* Test name */
...
GX_PROGRESS_BAR           *progress_bar;
    ...
    gx_progress_bar_info_set(progress_bar, &info);
    
    sprintf(test_comment, "Set progress_bar info.");
