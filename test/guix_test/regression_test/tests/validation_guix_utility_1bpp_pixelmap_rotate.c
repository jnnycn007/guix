...
TEST_PARAM test_parameter = {
    "guix_utility_1bpp_pixelmap_rotate", /* Test name */
    6, 68, 635, 404  /* Define the coordinates of the capture area.
...
int          memory_index;
    ...
    for(memory_index = 0; memory_index < 2; memory_index++)
    {
        if(memory_index)
        {
            ...
            tx_byte_pool_create(&rotate_pool, "test_memory_pool", test_memory,
