...
TEST_PARAM test_parameter = {
    "guix_sl_input_text_select", /* Test name */
...
static GX_CONST GX_UBYTE SINGLE_LINE_TEXT[] = "ABCDEFGHIJKLM";
...
int                        frame_id = 1;
    ...
    gx_single_line_text_input_text_select(text_input_ptr, 0, 10);
    gx_widget_show((GX_WIDGET *)text_input_ptr);

     sprintf(test_comment, "hide widget, select text, show widget");
