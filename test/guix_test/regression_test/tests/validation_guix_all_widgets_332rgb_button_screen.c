...
TEST_PARAM test_parameter = {
    "guix_all_widgets_332rgb_button_screen", /* Test name */
...
static int xpos_value[] = {60, 60, 60, 80, 40, 160, 160, 520, 525, 590, 600, 450, 600, 490, 600, 450, 610, 460};
/* Define the ypos values for the mouse.*/
static int ypos_value[] = {40, 100, 160, 260, 300, 350, 400, 80, 180, 80, 180, 235, 260, 290, 310, 325, 360, 380};
