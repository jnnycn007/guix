...
TEST_PARAM test_parameter = {
    "guix_standalone_binres_load_extended_unicode_32bpp", /* Test name */
...
#include "demo_guix_standalone_binres_load_extended_unicode_32bpp.c"
...
int frame_id = 1;
    ...
    gx_validation_set_frame_comment("main screen");
