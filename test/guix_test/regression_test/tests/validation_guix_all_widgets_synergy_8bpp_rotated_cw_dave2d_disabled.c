...
TEST_PARAM test_parameter = {
    "guix_all_widgets_synergy_8bpp_rotated_cw_dave2d_disabled", /* Test name */
...
#include "demo_guix_all_widgets_synergy_8bpp_rotated_cw_dave2d_disabled.c"

extern GX_STUDIO_DISPLAY_INFO all_widgets_synergy_8bpp_rotated_cw_dave2d_disabled_display_table[];
...
GX_CONST GX_THEME *theme_ptr;
    ...
    /* Save palette info. */
    theme_ptr = all_widgets_synergy_8bpp_rotated_cw_dave2d_disabled_display_table[MAIN_DISPLAY].theme_table[MAIN_DISPLAY_THEME_1];
