...
TEST_PARAM test_parameter = {
    "guix_all_widgets_radial_slider_needle_offset", /* Test name */
...
GX_RADIAL_SLIDER_INFO *info;
    ...
    info->gx_radial_slider_info_needle_offset = 20;
    gx_radial_slider_info_set(slider, info);

    gx_validation_set_frame_id(frame_id++);
    gx_validation_set_frame_comment("set needle offset to 20");
