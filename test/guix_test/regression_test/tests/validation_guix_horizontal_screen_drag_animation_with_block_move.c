...
TEST_PARAM test_parameter = {
    "guix_horizontal_screen_drag_animation_with_block_move", /* Test name */
...
#include "demo_screen_drag_animation_with_block_move.c"
    ...
    for(style_index = 0; style_index < 2; style_index++)
    {
        if(style_index)
        {
            ...
            enable_screen_drag_animation(&h_screen_drag_animation, h_screen_list, &main_screen.main_screen_h_menu_window,
                                         GX_ANIMATION_SCREEN_DRAG | GX_ANIMATION_HORIZONTAL | GX_ANIMATION_BLOCK_MOVE,
