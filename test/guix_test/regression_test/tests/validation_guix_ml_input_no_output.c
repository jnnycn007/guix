...
TEST_PARAM test_parameter = {
    "guix_ml_input_no_output", /* Test name */
...
GX_EVENT my_event;
    ...
    status = gx_multi_line_text_input_create(&text_input, "test ml input", GX_NULL,
    ...
    status = gx_multi_line_text_input_event_process(&text_input, &my_event);
    EXPECT_EQ(GX_SYSTEM_MEMORY_ERROR, status);
