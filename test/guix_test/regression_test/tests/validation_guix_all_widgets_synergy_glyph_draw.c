...
TEST_PARAM test_parameter = {
    "guix_all_widgets_synergy_glyph_draw", /* Test name */
...
#define _gx_synergy_display_driver_setup gx_validation_dave2d_graphics_driver_setup_24xrgb
...
#include "demo_guix_all_widgets_synergy.c"
