...
TEST_PARAM test_parameter = {
    "guix_text_input_cursor_height_set", /* Test name */
...
GX_EVENT my_event;
    ...
    cursor = &text_screen.text_screen_text_input_1.gx_single_line_text_input_cursor_instance;
    gx_single_line_text_input_style_remove(sl_text_input, GX_STYLE_CURSOR_BLINK);

    gx_text_input_cursor_height_set(cursor, 5);
    gx_system_dirty_mark(pTextScreen);
    sprintf(test_comment, "Set cursor height to 5.");
