...
TEST_PARAM test_parameter = {
    "guix_all_widgets_8bpp_rotated_cw_pixelmap_draw", /* Test name */
...
GX_BRUSH    *brush;
    ...
    /* Draw with unssuported format. */
    gx_context_pixelmap_get(GX_PIXELMAP_ID__RAW, &map);
