...
TEST_PARAM test_parameter = {
    "guix_all_widgets_icon_button_alignment", /* Test name */
    191, 380, 249, 421  /* Define the coordinates of the capture area.
...
GX_RECTANGLE     size;
    ...
    gx_widget_find(pButtonScreen, ID_ICON_BUTTON, 0, &button);
    gx_utility_rectangle_define(&size, 191, 380, 248, 420);
    ...
    gx_widget_hide((GX_WIDGET *)button);
    gx_icon_button_pixelmap_set(button, 0);
    gx_validation_set_frame_id(frame_id++);
    gx_validation_set_frame_comment("button is hidden");
    gx_validation_screen_refresh();
