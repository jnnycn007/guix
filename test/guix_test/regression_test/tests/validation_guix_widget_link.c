...
int        index;
    ...
    for(index = 0; index < 2; index++)
    {
        ...
        {
        case 0:
            _gx_widget_link(button, text_button);
            sprintf(test_comment, "link text_button to base_button");
            break;

        case 1:
            _gx_widget_link(button, multi_line_button);
            sprintf(test_comment, "link multi_line_button to base_button");
            break;
        }
    ...
    _gx_widget_link(GX_NULL, button);
