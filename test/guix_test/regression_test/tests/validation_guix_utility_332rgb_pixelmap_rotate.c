...
TEST_PARAM test_parameter = {
    "guix_utility_332rgb_pixelmap_rotate", /* Test name */
...
#define TEST_MEMORY_SIZE_17000 17000
#define TEST_MEMORY_SIZE_500   500

GX_COLOR test_memory_17000[TEST_MEMORY_SIZE_17000];
...
int          memory_index;
    ...
    for(memory_index = 0; memory_index < 3; memory_index++)
    {
        ...
        case 1:
            ...
            tx_byte_pool_create(&rotate_pool, "test_memory_pool_17000", test_memory_17000,
                        TEST_MEMORY_SIZE_17000 * sizeof(GX_COLOR));
            break;
        ...
        for(pixelmap_index = 0; pixelmap_index < (int)(sizeof(rotate_pixelmap_id_list) / sizeof(int)); pixelmap_index++)
        {
            ...
            for(angle_index = 0; angle_index < (int)(sizeof(angle_list)/sizeof(int)); angle_index++)
            {
                ...
                for(x_center = 0; x_center < 2; x_center++)
                {
                    ...
                    {
                    case 1:
                        strcat(test_comment, ", memory pool size = 17000 * 4(bytes)");
                        break;
                    case 2:
