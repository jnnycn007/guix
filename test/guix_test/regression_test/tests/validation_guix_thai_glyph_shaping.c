...
TEST_PARAM test_parameter = {
    "guix_thai_glyph_shaping", /* Test name */
...
#include "demo_thai_glyph_shaping.c"
...
int  pathlen;
    ...
    gx_validation_set_frame_comment("test generated thai string resource data");
    gx_validation_screen_refresh();

    gx_validation_extract_path(__FILE__, pathname, &pathlen);
    strcat(pathname, "..//..//..//example_internal//thai_glyph_shaping//thai_string_res.bin");
    ...
    gx_validation_set_frame_id(frame_id++);
    gx_validation_set_frame_comment("test generated thai string binary data");
    gx_validation_screen_refresh();
