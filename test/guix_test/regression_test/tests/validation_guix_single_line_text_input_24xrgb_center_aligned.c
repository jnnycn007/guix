...
TEST_PARAM test_parameter = {
    "guix_single_line_text_input_24xrgb_center_aligned", /* Test name */
...
static USHORT key_value[] = {GX_KEY_HOME, GX_KEY_DELETE, GX_KEY_RIGHT_ARROW, GX_KEY_END, GX_KEY_BACKSPACE, GX_KEY_LEFT_ARROW, GX_KEY_SELECT, GX_KEY_SPACE, 'q', 'a'};
                ...
                for (key_index = 0; key_index < (INT)(sizeof(key_value) / sizeof(USHORT)); key_index++)
                {
                        ...
                        || (y_point[y_index] < 196) || (y_point[y_index] > 231))
                    {
                        sprintf(test_comment, "text input already has %d characters, x: %d, y: %d, click outside, lose focus ", 
                                GX_STRLEN(text_input_ptr -> gx_single_line_text_input_buffer), x_point[x_index], y_point[y_index]);
