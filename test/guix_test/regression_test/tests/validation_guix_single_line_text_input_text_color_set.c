...
TEST_PARAM test_parameter = {
    "guix_single_line_text_input_text_color_set", /* Test name */
...
GX_EVENT my_event;
    ...
    gx_single_line_text_input_text_color_set(sl_text_input, GX_COLOR_ID_ORANGE, GX_COLOR_ID_BLUE, GX_COLOR_ID_WHITE, GX_COLOR_ID_SHADOW);
    
    gx_system_dirty_mark(sl_text_input);
    sprintf(test_comment, "Set text color to sl: normal: GX_COLOR_ID_ORANGE, selected: GX_COLOR_ID_BLUE, disabled: GX_COLOR_ID_WHITE, readonly: GX_COLOR_ID_SHADOW");
    gx_validation_set_frame_id(frame_id++);
    gx_validation_set_frame_comment(test_comment);
    gx_validation_screen_refresh();   
