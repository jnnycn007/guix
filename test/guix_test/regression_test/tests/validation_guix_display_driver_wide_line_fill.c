...
TEST_PARAM test_parameter = {
    "guix_display_driver_wide_line_fill", /* Test name */
...
GX_FIXED_POINT *points;
    ...
    _gx_display_driver_generic_wide_line_fill(_gx_system_current_draw_context, points);
...
int frame_id = 1;
    ...
    gx_validation_set_frame_comment("test _gx_display_driver_generic_wide_line_fill");
