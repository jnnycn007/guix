...
TEST_PARAM test_parameter = {
    "guix_circular_gauge_32bpp", /* Test name */
...
GX_CIRCULAR_GAUGE_INFO *gauge_info;
    ...
    gauge_info = &gauge->gx_circular_gauge_info;
    gauge_info->gx_circular_gauge_info_needle_pixelmap = GX_PIXELMAP_ID_WATCH_HAND_SECOND;
    gauge_info->gx_circular_gauge_info_needle_xcor = 2;
    gauge_info->gx_circular_gauge_info_needle_ycor = 100;

    gx_circular_gauge_angle_set(gauge, 30);
    gx_validation_set_frame_comment("Set angle to 30.");
    gx_validation_screen_refresh();

    gx_circular_gauge_angle_set(gauge, 60);
    gx_validation_set_frame_comment("Set angle to 60.");
    gx_validation_screen_refresh();
