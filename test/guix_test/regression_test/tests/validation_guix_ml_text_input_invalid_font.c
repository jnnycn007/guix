...
TEST_PARAM test_parameter = {
    "guix_ml_text_input_invalid_font", /* Test name */
...
GX_EVENT                  my_event;
    ...
    gx_multi_line_text_input_text_select(text_input, strlen(test_string) - 1, 0);
    gx_validation_set_frame_id(frame_id++);
    ...
    gx_system_event_send(&my_event);
    gx_validation_set_frame_id(frame_id++);
    sprintf(test_comment, "left arrow down");
    gx_validation_set_frame_comment(test_comment);
    gx_validation_screen_refresh();
    ...
    gx_system_event_send(&my_event);
    gx_validation_set_frame_id(frame_id++);
    sprintf(test_comment, "pen down on (100, 200)");
    gx_validation_set_frame_comment(test_comment);
    gx_validation_screen_refresh();
