...
TEST_PARAM test_parameter = {
    "guix_horizontal_list_wrap", /* Test name */
...
GX_HORIZONTAL_LIST *scroll_list = &window.window_horizontal_list_scroll;
GX_SCROLLBAR       *scroll = &window.window_hscroll_1;
int                 index;
    ...
    list->gx_horizontal_list_total_columns = 20;
    ...
    for(index = 0; index < 2; index++)
    {
        ...
        case 0:
           ...
           sprintf(test_comment, "total columns = 20, child widgets count = 0, set scroll event to wrap up");
           break;
        ...
        case 1:
           ...
           my_event.gx_event_type = GX_EVENT_HORIZONTAL_SCROLL;
           gx_system_event_send(&my_event);
           sprintf(test_comment, "total columns = 20, child widgets count = 0, set scroll event to wrap down");
           break;
        }
    ...
    list->gx_horizontal_list_child_count = 2;
    gx_horizontal_list_total_columns_set(list, 0);

    list->gx_horizontal_list_top_index = 1;    
    gx_horizontal_list_total_columns_set(list, 7);

    /* Test _gx_vertical_list_slide_back_check. */
    list->gx_horizontal_list_child_count = 0;
    _gx_horizontal_list_slide_back_check(list);

    list->gx_horizontal_list_child_count = 1;
    list->gx_horizontal_list_top_index = 10;
    _gx_horizontal_list_slide_back_check(list);
    ...
    scroll_list->gx_horizontal_list_total_columns = 20;
    gx_scrollbar_reset(scroll, GX_NULL);
    
    scroll_list->gx_horizontal_list_top_index = -1;
    gx_scrollbar_reset(scroll, GX_NULL);
