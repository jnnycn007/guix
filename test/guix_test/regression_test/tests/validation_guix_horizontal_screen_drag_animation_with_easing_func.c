...
TEST_PARAM test_parameter = {
    "guix_horizontal_screen_drag_animation_with_easing_func", /* Test name */
...
{GX_EVENT_PEN_DRAG, XPOS + 50,  YPOS, 11, "pen drag"}, 
...
GX_VERTICAL_LIST *list;
    ...
    test_comments[0] = "drag right with easing function been set.";
    tx_thread_sleep(1);
