...
TEST_PARAM test_parameter = {
    "guix_sl_input_gain_lose_focus", /* Test name */
...
static GX_CHAR english_text[] = "ABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789abcdefghijklmnoqqrstuvwxyz";
...
int                        frame_id = 1;
    ...
    sprintf(test_comment, "gaim focus");
