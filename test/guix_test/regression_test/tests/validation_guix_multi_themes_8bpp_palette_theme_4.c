...
TEST_PARAM test_parameter = {
    "guix_multi_themes_8bpp_palette_theme_4", /* Test name */
...
GX_EVENT select_event;
    ...
    {
        gx_binres_theme_load(binres_root_address, 0, &theme);
        gx_validation_write_palette(theme -> theme_palette, theme->theme_palette_size);
        ...
        gx_validation_set_frame_comment("Select Theme 4");
