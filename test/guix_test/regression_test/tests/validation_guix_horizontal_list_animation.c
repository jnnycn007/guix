...
TEST_PARAM test_parameter = {
    "guix_horizontal_list_animation", /* Test name */
...
TEST test_list[]={
{GX_EVENT_PEN_DOWN,         XPOS,       YPOS,      0, 5, 0, "pen down"},/* Drag right. */
{GX_EVENT_PEN_DRAG,         XPOS + 100, YPOS,      0,11, 1, "drag right"}, 
{GX_EVENT_PEN_UP,           XPOS + 100, YPOS,      0, 5, 5, "pen up"},
{GX_EVENT_HORIZONTAL_FLICK, 0,             0,  10240, 0, 5, "flick right"},
{GX_EVENT_PEN_DOWN,         XPOS,       YPOS,      0, 5, 0, "pen down"},/* Drag left. */
{GX_EVENT_PEN_DRAG,         XPOS - 100, YPOS,      0,11, 2, "drag left"},
{GX_EVENT_PEN_UP,           XPOS - 100, YPOS,      0, 5, 0, "pen up"},
{GX_EVENT_HORIZONTAL_FLICK, 0,             0, -10240, 0, 4, "flick left"},
{GX_EVENT_PEN_DOWN,         XPOS,       YPOS,      0, 5, 0, "pen down"},/* Drag left. */
{GX_EVENT_PEN_DRAG,         XPOS - 100, YPOS,      0,11, 2, "drag left"},
{GX_EVENT_PEN_UP,           XPOS - 100, YPOS,      0, 5, 0, "pen up"},
{GX_EVENT_PEN_DOWN,         XPOS,       YPOS,      0, 5, 0, "pen down"},/* Drag left. */
...
{GX_EVENT_PEN_UP,           XPOS - 100, YPOS,      0, 5, 0, "pen up"},
{GX_EVENT_PEN_DOWN,         XPOS,       YPOS,      0, 5, 0, "pen down"},/* Drag left. */
{GX_EVENT_PEN_DRAG,         XPOS - 150, YPOS,      0,11, 2, "drag left"},
{GX_EVENT_PEN_UP,           XPOS - 150, YPOS,      0, 5, 0, "pen up"},
{GX_EVENT_HORIZONTAL_FLICK, 0,             0, -10240, 0, 5, "flick left"},
{0, 0, 0, 0, 0, 0, 0}
};
...
TEST               *test;
GX_EVENT            my_event;
GX_HORIZONTAL_LIST *list = &pMainScreen->window_horizontal_list_scroll;
GX_CHAR            *test_comment[1];
    ...
    while(test->event_type)
    {
        ...
        if(my_event.gx_event_type == GX_EVENT_HORIZONTAL_FLICK)
        {
        ...
        if(test->event_type == GX_EVENT_PEN_UP || test->event_type == GX_EVENT_HORIZONTAL_FLICK)
        {
