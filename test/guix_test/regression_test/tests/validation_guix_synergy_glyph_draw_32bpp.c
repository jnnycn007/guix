...
TEST_PARAM test_parameter = {
    "guix_synergy_glyph_draw_32bpp", /* Test name */
...
#include "demo_synergy_glyph_draw_32bpp.c"

int xpos_value[]={0, 380, 440};
int ypos_value[]={0, 260, 320};
...
GX_EVENT my_event;
    ...
    my_event.gx_event_payload.gx_event_pointdata.gx_point_y = 454;
    ...
    my_event.gx_event_payload.gx_event_pointdata.gx_point_x = 585; 
