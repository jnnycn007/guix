...
TEST_PARAM test_parameter = {
    "guix_all_widgets_16bpp_rotated_ccw_binary_pixelmap_draw", /* Test name */
...
#include "demo_guix_all_widgets_16bpp_rotated_ccw_binary.c"

char test_comment[256];

GX_RESOURCE_ID test_map_id_list[]=
{
GX_PIXELMAP_ID__565RGB_C_A,/* Compressed, Alpha. */
GX_PIXELMAP_ID__565RGB_A,/* Alpha. */
...
GX_PIXELMAP_ID_PALETTE_C_A, /* 8bit palette transparent compressed. */
GX_PIXELMAP_ID_PALETTE_A, /* 8bit palette transparent raw. */
GX_PIXELMAP_ID_PALETTE_C, /* 8bit palette compressed. */
GX_PIXELMAP_ID_PALETTE, /* 8bit palette raw. */
GX_PIXELMAP_ID_ALPHAMAP_C_A, /* alphamap compressed. */
GX_PIXELMAP_ID_ROTATE_ALPHAMAP, /* alphamap raw. */
