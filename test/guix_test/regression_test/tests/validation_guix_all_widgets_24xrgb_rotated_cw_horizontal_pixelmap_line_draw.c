...
TEST_PARAM test_parameter = {
    "guix_all_widgets_24xrgb_rotated_cw_horizontal_pixelmap_line_draw", /* Test name */
...
GX_PIXELMAP_ID__24XRGB,/*raw*/
GX_PIXELMAP_ID__24XRGB_A,/*alpha*/
GX_PIXELMAP_ID__24XRGB_C,/*compressed*/
GX_PIXELMAP_ID__24XRGB_C_A,/*compressed, alpha*/
};
