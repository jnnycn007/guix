...
TEST_PARAM test_parameter = {
    "guix_vertical_list_child_height", /* Test name */
...
GX_EVENT my_event;
    ...
    gx_widget_attach(root, &list_child_height_test_screen);
    ...
    my_event.gx_event_type = GX_EVENT_PEN_DOWN;
    my_event.gx_event_payload.gx_event_pointdata.gx_point_x = 540;
    my_event.gx_event_payload.gx_event_pointdata.gx_point_y = 299;
    gx_system_event_send(&my_event);
    ...
    gx_validation_set_frame_id(frame_id++);
    gx_validation_set_frame_comment("Scroll the horizontal list.");
    gx_validation_screen_refresh();
