...
#include "demo_glyph_draw_8bpp_screen_text_colors_16.c"

int clip_width[] = {5, 10, 15, 20, 25, 30};

char test_comment[256];
extern GX_STUDIO_DISPLAY_INFO glyph_draw_8bpp_screen_text_colors_16_display_table[];
...
GX_CONST GX_THEME *theme_ptr;
    ...
    /*Save palette. */
    theme_ptr = glyph_draw_8bpp_screen_text_colors_16_display_table[DISPLAY_1].theme_table[0];
