...
TEST_PARAM test_parameter = {
    "guix_multi_line_text_view_visible_row_compute", /* Test name */
...
int frame_id = 1;
    ...
    sprintf(test_comment, "set text to text view: 0123456789 abcdefghijklmnopqrstuvwxyz");
    ...
    gx_validation_set_frame_id(frame_id);
    gx_validation_set_frame_comment(test_comment);
    gx_multi_line_text_view_font_set(&pMainWin -> main_window_text_view, 0xff);
    sprintf(test_comment, "Set invalid font id to text view and make it redraw.");
