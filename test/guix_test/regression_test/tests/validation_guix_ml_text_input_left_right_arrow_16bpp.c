...
TEST_PARAM test_parameter = {
    "guix_ml_text_input_left_right_arrow_16bpp", /* Test name */
...
char test_string[]="dodo youyou rememmber thethethethe";
GX_RESOURCE_ID text_alignment[] = {
    GX_STYLE_TEXT_LEFT,
...
int                       loop;
    ...
    for(index = 0; index < (int)(sizeof(text_alignment) / sizeof(GX_RESOURCE_ID)); index++)
    {
        ...
        gx_validation_set_frame_id(frame_id++);
        sprintf(test_comment, "Set text alignment");
        gx_validation_set_frame_comment(test_comment);
