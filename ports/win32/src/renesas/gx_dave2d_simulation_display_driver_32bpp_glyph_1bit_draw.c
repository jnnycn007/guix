...
VOID (*blend_func)(GX_DRAW_CONTEXT *, INT, INT, GX_COLOR, GX_UBYTE);
    ...
    pixel_per_row = (GX_VALUE)(draw_area -> gx_rectangle_right - draw_area -> gx_rectangle_left + 1);
    ...
    pixel_in_first_byte = (GX_UBYTE)(8 - ((map_offset -> gx_point_x) & 0x7));
    ...
    if (num_bytes != 1)
    {
        pixel_in_last_byte = (map_offset -> gx_point_x + (GX_VALUE)pixel_per_row) & 0x7;
