                                                                                ...
                                                                                GX_RECTANGLE *dirty_area))
{
    ...
    display -> gx_display_driver_pixelmap_draw                 = _gx_dave2d_simulation_display_driver_565rgb_rotated_pixelmap_draw;
    display -> gx_display_driver_pixelmap_blend                = _gx_dave2d_simulation_display_driver_565rgb_rotated_pixelmap_blend;
    display -> gx_display_driver_4bit_glyph_draw               = _gx_dave2d_simulation_display_driver_rotated_glyph_4bit_draw;
    display -> gx_display_driver_1bit_glyph_draw               = _gx_dave2d_simulation_display_driver_16bpp_rotated_glyph_1bit_draw;
    ...
    display -> gx_display_driver_1bit_compressed_glyph_draw    = _gx_dave2d_simulation_display_driver_16bpp_rotated_compressed_glyph_1bit_draw;
    display -> gx_display_driver_horizontal_pixelmap_line_draw = _gx_dave2d_simulation_display_driver_565rgb_rotated_horizontal_pixelmap_line_draw;
}
