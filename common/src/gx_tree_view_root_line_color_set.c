...
/*  FUNCTION                                               RELEASE        */
/*                                                                        */
/*    _gx_tree_view_root_line_color_set                   PORTABLE C      */
/*                                                           6.1          */
/*  AUTHOR                                                                */
/*                                                                        */
...
/*                                                                        */
/**************************************************************************/
UINT  _gx_tree_view_root_line_color_set(GX_TREE_VIEW *tree, GX_RESOURCE_ID color_id)
{
    tree -> gx_tree_view_root_line_color = color_id;
