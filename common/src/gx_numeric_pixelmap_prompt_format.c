...
/*  FUNCTION                                               RELEASE        */
/*                                                                        */
/*    _gx_numeric_pixelmap_prompt_format                  PORTABLE C      */
/*                                                           6.1          */
/*  AUTHOR                                                                */
/*                                                                        */
...
/*  DESCRIPTION                                                           */
/*                                                                        */
/*    This function formats an integer value to string for a numeric      */
/*    pixelmap prompt widget.                                             */
/*                                                                        */
/*  INPUT                                                                 */
/*                                                                        */
...
VOID _gx_numeric_pixelmap_prompt_format(GX_NUMERIC_PIXELMAP_PROMPT *prompt, INT value)
{
    ...
    _gx_utility_ltoa(value, (GX_CHAR *)prompt -> gx_numeric_pixelmap_prompt_buffer, GX_NUMERIC_PROMPT_BUFFER_SIZE);
}
