...
/*  FUNCTION                                               RELEASE        */
/*                                                                        */
/*    _gx_single_line_text_input_style_set                PORTABLE C      */
/*                                                           6.1          */
/*  AUTHOR                                                                */
/*                                                                        */
...
UINT _gx_single_line_text_input_style_set(GX_SINGLE_LINE_TEXT_INPUT *text_input, ULONG style)
{
    ...
    _gx_single_line_text_input_style_remove(text_input, text_input -> gx_widget_style);

    _gx_single_line_text_input_style_add(text_input, style);
