                                                             ...
                                                             GX_RECTANGLE *dirty_area))
{
    ...
    display -> gx_display_mouse_capture                        = _gx_display_driver_16bpp_mouse_capture;
    display -> gx_display_mouse_restore                        = _gx_display_driver_16bpp_mouse_restore;
    ...
    display -> gx_display_color_format                         = GX_COLOR_FORMAT_565RGB;
    ...
    display -> gx_display_driver_horizontal_pixelmap_line_draw = _gx_display_driver_565rgb_horizontal_pixelmap_line_draw;
    ...
    display -> gx_display_driver_pixelmap_rotate               = _gx_display_driver_16bpp_pixelmap_rotate;
    ...
    display -> gx_display_driver_jpeg_draw                     = _gx_display_driver_565rgb_jpeg_draw;
