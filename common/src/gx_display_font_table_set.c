...
/*  FUNCTION                                               RELEASE        */
/*                                                                        */
/*    _gx_display_font_table_set                          PORTABLE C      */
/*                                                           6.1          */
/*  AUTHOR                                                                */
/*                                                                        */
...
UINT  _gx_display_font_table_set(GX_DISPLAY *display, GX_FONT **font_table, UINT number_of_fonts)
{
    ...
    /* Setup the system font table information.  */
    display -> gx_display_font_table = font_table;
    display -> gx_display_font_table_size =  number_of_fonts;
