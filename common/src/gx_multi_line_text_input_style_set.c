...
/*  FUNCTION                                               RELEASE        */
/*                                                                        */
/*    _gx_multi_line_text_input_style_set                 PORTABLE C      */
/*                                                           6.1          */
/*  AUTHOR                                                                */
/*                                                                        */
...
UINT status;
    ...
    _gx_multi_line_text_input_style_remove(text_input, text_input -> gx_widget_style);
    status = _gx_multi_line_text_input_style_add(text_input, style);
