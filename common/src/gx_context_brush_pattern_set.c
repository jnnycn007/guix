...
/*  FUNCTION                                               RELEASE        */
/*                                                                        */
/*    _gx_context_brush_pattern_set                       PORTABLE C      */
/*                                                           6.1          */
/*  AUTHOR                                                                */
/*                                                                        */
...
GX_DRAW_CONTEXT *context = _gx_system_current_draw_context;
    ...
    /* Set the brush.  */
    context -> gx_draw_context_brush.gx_brush_line_pattern = pattern;
    context -> gx_draw_context_brush.gx_brush_pattern_mask = 0x80000000;
