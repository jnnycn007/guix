...
/*  FUNCTION                                               RELEASE        */
/*                                                                        */
/*    _gx_menu_text_offset_set                            PORTABLE C      */
/*                                                           6.1          */
/*  AUTHOR                                                                */
/*                                                                        */
...
{
    menu -> gx_menu_text_x_offset = x_offset;
    menu -> gx_menu_text_y_offset = y_offset;

    if (menu -> gx_widget_status & GX_STATUS_VISIBLE)
    {
        _gx_system_dirty_mark((GX_WIDGET *)menu);
    }
