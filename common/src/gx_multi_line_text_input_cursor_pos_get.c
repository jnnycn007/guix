...
/*  FUNCTION                                               RELEASE        */
/*                                                                        */
/*    _gx_multi_line_text_input_cursor_pos_get            PORTABLE C      */
/*                                                           6.1          */
/*  AUTHOR                                                                */
/*                                                                        */
...
{
GX_TEXT_INPUT_CURSOR *cursor_instance = &input -> gx_multi_line_text_input_cursor_instance;

    *cursor_pos = cursor_instance -> gx_text_input_cursor_pos;
