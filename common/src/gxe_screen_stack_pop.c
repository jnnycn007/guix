...
/*  FUNCTION                                               RELEASE        */
/*                                                                        */
/*    _gxe_screen_stack_pop                               PORTABLE C      */
/*                                                           6.1          */
/*  AUTHOR                                                                */
/*                                                                        */
...
/*  CALLS                                                                 */
/*                                                                        */
/*    _gx_screen_stack_pop                  The actual screen stack       */
/*                                            pop routine                 */
/*                                                                        */
/*  CALLED BY                                                             */
/*                                                                        */
...
UINT status;
    ...
    /* Call actual screen stack pop function.  */
    status = _gx_screen_stack_pop(control);

    /* Return the error status from screen stack pop.  */
    return(status);
}
